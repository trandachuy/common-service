...
public class DataTypeMapperIntegerTests extends AbstractDataTypeMapperNumberTests<Integer> {

    public static final Integer TEST_NUMBER = 123457890;
    ...
    @Override
    protected Integer getTestNumber() {
        return TEST_NUMBER;
    }
