...
public class DataTypeMapperBigIntegerTests extends AbstractDataTypeMapperNumberTests<BigInteger> {

    public static final BigInteger TEST_NUMBER = new BigInteger("1234567890123456789012345678901234567890");
    ...
    static {
        ...
        for (int i = 0; i < TEST_LIST_SIZE; i++) {
            BigInteger value = TEST_NUMBER.add(new BigInteger(String.valueOf(i)));
    ...
    @Override
    protected BigInteger getTestNumber() {
        return TEST_NUMBER;
    }
